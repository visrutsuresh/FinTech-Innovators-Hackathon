...
export const mockClients: Client[] = [
  {
    ...
    portfolio: {
      assets: [
        ...
        { id: 'a4', name: 'Tesla', ticker: 'TSLA', assetClass: AssetClass.STOCKS, value: 12000, currency: 'USD', quantity: 30, finageSymbol: 'TSLA' },
  ...
  },
  {
    ...
    portfolio: {
      assets: [
        { id: 'b1', name: 'Apple', ticker: 'AAPL', assetClass: AssetClass.STOCKS, value: 45000, currency: 'USD', quantity: 200, finageSymbol: 'AAPL' },
        { id: 'b2', name: 'Microsoft', ticker: 'MSFT', assetClass: AssetClass.STOCKS, value: 38000, currency: 'USD', quantity: 80, finageSymbol: 'MSFT' },
        { id: 'b3', name: 'S&P 500 ETF', ticker: 'SPY', assetClass: AssetClass.STOCKS, value: 30000, currency: 'USD', quantity: 60, finageSymbol: 'SPY' },
  ...
  },
  {
    ...
    portfolio: {
      assets: [
        ...
        { id: 'c4', name: 'JPMorgan Chase', ticker: 'JPM', assetClass: AssetClass.STOCKS, value: 15000, currency: 'USD', quantity: 75, finageSymbol: 'JPM' },
  ...
  },
  {
    ...
    portfolio: {
      assets: [
        ...
        { id: 'd2', name: 'Nasdaq 100 ETF', ticker: 'QQQ', assetClass: AssetClass.STOCKS, value: 42000, currency: 'USD', quantity: 80, finageSymbol: 'QQQ' },
  ...
  },
  {
    ...
    portfolio: {
      assets: [
        ...
        { id: 'e5', name: 'NVIDIA', ticker: 'NVDA', assetClass: AssetClass.STOCKS, value: 28000, currency: 'USD', quantity: 20, finageSymbol: 'NVDA' },
