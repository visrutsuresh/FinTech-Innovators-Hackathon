      ...
      >
        ...
        >
          <div className="text-center mb-8">
            <div className="text-4xl font-black mb-2" style={{ color: '#F5C842' }}>Huat 🤑</div>
          ...
          <div className="mt-6 p-4 rounded-xl space-y-1" style={{ background: 'rgba(255,255,255,0.03)' }}>
            <p className="text-xs text-white/40 font-medium mb-2">Demo Accounts (password: demo123)</p>
            {[
          ...
          <p className="text-center text-sm text-white/40 mt-6">
            No account?{' '}
            <Link href="/auth/signup" className="hover:text-white transition-colors" style={{ color: '#F5C842' }}>
              Sign up
            </Link>
          </p>
        </div>
